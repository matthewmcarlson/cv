...
\begin{itemize}
  \item Reed College: B.A. in Mathematics, 2012
	\begin{itemize}
        \item Senior Thesis at Reed College: \textit{Euclidean Embedding Of Network Location Data}: Design And Use, 2012
...
\item Allion USA: Software Engineer, October 2012--Present
    ...
    \item Set up and maintaining several servers (physical-local, physical-virtual, and cloud-virtual), including on the Amazon Web Services platform%, for various purposes including running Nginx/uWSGI web server

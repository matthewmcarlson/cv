...
\item Allion USA: Software Engineer, October 2012--Present
    ...
    \item Set up and maintained several servers (physical-local, physical-virtual, and cloud-virtual), including on the Amazon Web Services platform%, for various purposes including running Nginx/uWSGI web server
